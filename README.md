...
```Groovy
implementation 'com.google.cloud:google-cloud-pubsublite:1.4.11'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-pubsublite" % "1.4.11"
```
