...
//        Subscriber subscriber = null;
        ...
        BlockingPullSubscriberImpl subscriber = new BlockingPullSubscriberImpl(
                subscriberFactory, FlowControlSettings.builder()
                .setMessagesOutstanding(Long.MAX_VALUE)
                .setBytesOutstanding(Long.MAX_VALUE).build(),
        ...
        while (true) {
            ...
            subscriber.messageIfAvailable().ifPresent((msg) -> {
