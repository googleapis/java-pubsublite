...
public class MultiPartitionSubscriber extends ProxyService implements Subscriber {
  public static Subscriber of(Subscriber... subscribers) throws StatusException {
    return new MultiPartitionSubscriber(subscribers);
  }

  private MultiPartitionSubscriber(Subscriber... subscribers) throws StatusException {
