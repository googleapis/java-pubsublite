 ...
 *      <td><p>Compute statistics about a range of messages in a given topic and
 *  partition.</p></td>
 *      <td>
 ...
 *      <td><p>Compute the head cursor for the partition.
 ...
 *      <td><p>Compute the corresponding cursor for a publish or event time in a topic
 *  partition.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
