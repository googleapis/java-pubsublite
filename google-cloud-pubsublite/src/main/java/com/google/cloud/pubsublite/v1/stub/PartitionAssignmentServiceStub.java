...
public abstract class PartitionAssignmentServiceStub implements BackgroundResource {

  public BidiStreamingCallable<PartitionAssignmentRequest, PartitionAssignment>
      assignPartitionsCallable() {
    throw new UnsupportedOperationException("Not implemented: assignPartitionsCallable()");
  }
