...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.pubsublite.proto.ListSubscriptionsResponse result) {
      if (subscriptionsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.pubsublite.proto.ListSubscriptionsResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.pubsublite.proto.Subscription m =
                  input.readMessage(
                      com.google.cloud.pubsublite.proto.Subscription.parser(),
                      extensionRegistry);
              if (subscriptionsBuilder_ == null) {
                ensureSubscriptionsIsMutable();
