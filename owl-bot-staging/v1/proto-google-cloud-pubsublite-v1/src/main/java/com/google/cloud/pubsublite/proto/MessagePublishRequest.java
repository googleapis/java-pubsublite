...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (firstSequenceNumber_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(2, firstSequenceNumber_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getFirstSequenceNumber()
        != other.getFirstSequenceNumber()) return false;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.pubsublite.proto.MessagePublishRequest result) {
      if (messagesBuilder_ == null) {
