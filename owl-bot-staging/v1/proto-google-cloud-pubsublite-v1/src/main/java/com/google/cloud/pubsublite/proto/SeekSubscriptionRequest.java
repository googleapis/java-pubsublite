...
private static final long serialVersionUID = 0L;
  ...
  public com.google.cloud.pubsublite.proto.SeekSubscriptionRequest.NamedTarget getNamedTarget() {
    if (targetCase_ == 2) {
      com.google.cloud.pubsublite.proto.SeekSubscriptionRequest.NamedTarget result = com.google.cloud.pubsublite.proto.SeekSubscriptionRequest.NamedTarget.forNumber(
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.cloud.pubsublite.proto.SeekSubscriptionRequest result) {
      result.targetCase_ = targetCase_;
      result.target_ = this.target_;
      if (targetCase_ == 3 &&
          timeTargetBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getTimeTargetFieldBuilder().getBuilder(),
                  extensionRegistry);
              targetCase_ = 3;
              break;
            } // case 26
