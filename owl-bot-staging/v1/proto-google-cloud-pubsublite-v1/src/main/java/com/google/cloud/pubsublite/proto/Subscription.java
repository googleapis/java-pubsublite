      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            ...
            exportConfig_ = input.readMessage(com.google.cloud.pubsublite.proto.ExportConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeExportConfig(com.google.cloud.pubsublite.proto.ExportConfig value) {
      if (exportConfigBuilder_ == null) {
        if (exportConfig_ != null) {
          exportConfig_ =
            com.google.cloud.pubsublite.proto.ExportConfig.newBuilder(exportConfig_).mergeFrom(value).buildPartial();
        } else {
          exportConfig_ = value;
        }
        onChanged();
