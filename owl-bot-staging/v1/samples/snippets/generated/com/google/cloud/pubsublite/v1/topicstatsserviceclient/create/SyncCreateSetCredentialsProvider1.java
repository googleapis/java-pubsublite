...
// [START pubsublite_v1_generated_topicstatsserviceclient_create_setcredentialsprovider1_sync]
    ...
    TopicStatsServiceSettings topicStatsServiceSettings =
        TopicStatsServiceSettings.newBuilder()
            .setTransportChannelProvider(
                TopicStatsServiceSettings.defaultHttpJsonTransportProviderBuilder().build())
            .build();
    TopicStatsServiceClient topicStatsServiceClient =
        TopicStatsServiceClient.create(topicStatsServiceSettings);
  }
}
// [END pubsublite_v1_generated_topicstatsserviceclient_create_setcredentialsprovider1_sync]
