...
import com.google.cloud.pubsublite.FlowControlSettings;
...
public class SubscriberExample {
  ...
  private static final List<int> PARTITIONS = List.of(3, 7);
  ...
  static class MessageReceiverExample implements MessageReceiver {
    ...
    public void receiveMessage(PubsubMessage message, AckReplyConsumer consumer) {
      System.out.println("Partition: " + partition + " Message Id: " + message.getMessageId() + " Data: " + message.getData().toStringUtf8());
  ...
  public static void run() throws Exception {
    SubscriberBuilder.Builder builder = SubscriberBuilder.builder();
    builder.setSubscriptionPath(SubscriptionPaths.newBuilder()
